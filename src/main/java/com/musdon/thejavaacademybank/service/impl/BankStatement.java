...
public class BankStatement {
    ...
    private static final String FILE = "C:\\Users\\nguye\\Documents\\MyStatement.pdf";
    /**
     * retrieve list of transactions within a date given an account number
     * generate a pdf file or transaction
    ...
    public List<Transaction> generateStatement(String accountNumber, String startDate, String endDate) throws DocumentException, FileNotFoundException {
        ...
        PdfPCell bankAddress = new PdfPCell(new Phrase("21/32 Vu Hong Pho"));
        ...
        transactionList.forEach(transaction -> {
            transactionsTable.addCell(new Phrase(String.valueOf(transaction.getCreatedAt())));
